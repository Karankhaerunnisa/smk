        ...
        <table class="signature-table">
            <tr>
                <td class="signature-box signature-left">
                    ...
                    <span style="font-size: 10pt;">NIP. {{ \App\Models\Setting::getValue('principal_nip') }}</span>
                    @endif
                </td>
                <td class="signature-box signature-right">
                    ...
                    @if($ttd)
                    <div style="height: 70px; text-align: center;">
                        <img src="{{ public_path('images/' . $ttd) }}" style="max-width: 100px; max-height: 60px;" alt="TTD">
                    </div>
                    @else
                    <br><br><br><br>
                    @endif
                    ...
                    <span style="font-size: 10pt;">NUPTK. {{ \App\Models\Setting::getValue('committee_head_nip') }}</span>
                    @endif
                </td>
            </tr>
        </table>
